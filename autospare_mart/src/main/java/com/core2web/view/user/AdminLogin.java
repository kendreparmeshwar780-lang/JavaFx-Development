...
public class AdminLogin extends Application {
    ...
    public void start(Stage arg0) throws Exception {
        ...
        listView.getItems().addAll("Users", "Companies", "Product Approvals ", "Orders", "Complaints", "Reviews",
                "Notification");
        ...
        listView.setOnMouseClicked(event -> {
            ...
            if (selected_item.equals("Users")) {
                ...
                TableColumn<AdminModelCompany, String> companyNameColumn = new TableColumn<>("Company Name");
                ...
                tableView.getColumns().addAll(companyNameColumn, cityColumn, listingColumn, documentsColumn,
                ...
                tableView.getItems().addAll(
                        ...
                        new AdminModelCompany("Mahindra", "Nagpur", 12, "Rejected", "DeActive"));
                ...
                TableColumn<AdminModelOrders, String> customerNameColumn = new TableColumn<>("Customer Name");
                ...
                tableView.getColumns().addAll(ordersColumn, customerNameColumn, companyColumn, valueColumn,paymentColumn,statusColumn);

                tableView.getItems().addAll(
                        new AdminModelOrders("#ORD-101", "Rahul kadam", "Bajaj", 15400.00, "Paid"),
                        new AdminModelOrders("#ORD-102", "Priya shelke", "BMW", 82000.50, "Pending"),
                        new AdminModelOrders("#ORD-103", "Amit Mhetre", "Honda", 12300.00, "Paid"),
                        new AdminModelOrders("#ORD-104", "Neha patil", "Mahindra", 45000.75, "Failed"));
    ...
    Button restoreButton =
            new Button("Restore from backup");
