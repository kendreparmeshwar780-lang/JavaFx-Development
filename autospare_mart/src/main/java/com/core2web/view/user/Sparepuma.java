...
public class Sparepuma {
     private BorderPane homebBorderPane;
     BorderPane getpumapart() {
        Label l1 = new Label("Spare Parts of 2026 Ford puma");
        l1.setStyle("-fx-font-size: 24px; -fx-font-weight: bold; -fx-text-fill: #7d1c1c;");
        l1.setAlignment(Pos.CENTER);

        Image img1 = new Image("asssets\\icons\\spark plug.jpeg");
        ...
        Image img2 = new Image("asssets//icons//starter motor.jpeg");
        ...
        btn4.setOnAction(event->{
         ...
         Image img5 = new Image("asssets\\icons\\bumper.jpeg");
        ...
        Image img6 = new Image("asssets\\icons\\bumper.jpeg");
        ...
        Image img7 = new Image("asssets\\icons\\bumper.jpeg");
        ...
        Image img8 = new Image("asssets\\icons\\bumper.jpeg");
