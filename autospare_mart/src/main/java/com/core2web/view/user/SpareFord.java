...
public class SpareFord   {
    private BorderPane homebBorderPane;
     BorderPane getfordpart() {
        Label l1 = new Label("Spare Parts of 2026 Ford F-150");
        l1.setStyle("-fx-font-size: 24px; -fx-font-weight: bold; -fx-text-fill: #7d1c1c;");
        l1.setAlignment(Pos.CENTER);

        Image img1 = new Image("assets\\images\\sparepart\\spark plug.jpeg");
        ...
        Image img2 = new Image("assets\\images\\sparepart\\starter motor.jpeg");
       ...
       btn5.setStyle("-fx-background-color: #7b0e0e; -fx-text-fill: #d9d6d6; -fx-font-size: 16px; -fx-padding: 5px 10px; -fx-border-radius: 5px; -fx-cursor: hand;");
        ...
        btn6.setStyle("-fx-background-color: #7b0e0e; -fx-text-fill: #d9d6d6; -fx-font-size: 16px; -fx-padding: 5px 10px; -fx-border-radius: 5px; -fx-cursor: hand;");
