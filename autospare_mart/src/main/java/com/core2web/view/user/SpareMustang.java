...
public class SpareMustang {
     private BorderPane homebBorderPane;
     BorderPane getMustangtapart() {
        Label l1 = new Label("Spare Parts of 2026 Ford Mustang");
        l1.setStyle("-fx-font-size: 24px; -fx-font-weight: bold; -fx-text-fill: #7d1c1c;");
        l1.setAlignment(Pos.CENTER);

        Image img1 = new Image("aassets\\images\\sparepart\\spark plug.jpeg");
        ...
        Image img3 = new Image("asssets//icons//hood.jpeg");
        ...
        Image img4 = new Image("asssets\\icons\\blade.jpeg");
        ...
        btn4.setStyle("-fx-background-color: #c72a2a; -fx-text-fill: #f5e6e6; -fx-font-size: 16px; -fx-padding: 5px 10px; -fx-border-radius: 5px; -fx-cursor: hand;");
